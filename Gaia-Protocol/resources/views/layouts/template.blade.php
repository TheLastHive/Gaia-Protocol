...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-warning shadow-sm d-flex justify-content-between px-3 py-2">
          
                <div class="sidebar2 d-flex flex-grow-1">
                    
                    <div class="d-flex">
                        <a><button class="btn rounded-5 btn-secondary me-1">A</button></a>
                        <a><button class="btn rounded-5 btn-secondary me-1">A</button></a>
                        <a><button class="btn rounded-5 btn-secondary me-1">A</button></a>
                        <a><button class="btn rounded-5 btn-secondary me-1">A</button></a>
                        <a><button class="btn rounded-5 btn-secondary me-1">A</button></a>
